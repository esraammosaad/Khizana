...
data class OrdersItem(
    ...
    val current_total_discounts_set: Current_total_discounts_set?,
    val billing_address: Billing_address?,
    val line_items: List<Line_itemsItem?>?,
    val original_total_duties_set: String?,
    val presentment_currency: String?,
    val total_discounts_set: Total_discounts_set?,
    ...
    val current_total_price_set: Current_total_price_set?,
    val device_id: String?,
    val test: Boolean?,
    val total_shipping_price_set: Total_shipping_price_set?,
    val subtotal_price_set: Subtotal_price_set?,
    val tax_exempt: Boolean?,
    val payment_gateway_names: List<String?>?,
    val total_tax: String?,
    val tags: String?,
    val current_subtotal_price_set: Current_subtotal_price_set?,
    ...
    val total_price_set: Total_price_set?,
...
data class Current_total_discounts_set(
    val shop_money: Shop_money?,
    val presentment_money: Presentment_money?
)
...
data class Line_itemsItem(
    ...
    val total_discount_set: Total_discount_set?,
    val title: String?,
...
data class Customer(
    val note: String?,
    val tax_exempt: Boolean?,
    val email_marketing_consent: Email_marketing_consent?,
    val created_at: String?,
    val last_name: String?,
    val multipass_identifier: String?,
    val verified_email: Boolean?,
    val tags: String?,
    val sms_marketing_consent: Sms_marketing_consent?,
...
data class Email_marketing_consent(
    val consent_updated_at: String?,
    val state: String?,
    val opt_in_level: String?
)

data class Sms_marketing_consent(
    val consent_updated_at: String?,
